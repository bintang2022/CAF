            ...
            <div class="card-body">
              ...
              <div style="width: 241px; height: 37px; position: relative; left: 50%; transform: translateX(-50%);">
                <div style="width: 241px; height: 37px; left: 0px; top: 0px; position: absolute">
                  ...
                  <a href="kontrol">
                    <div style="left: 29px; top: 6px; position: absolute; color: black; font-size: 16px; font-family: Poppins; font-weight: 400; word-wrap: break-word">Jadwal</div>
                  </a>
                </div>
                <div style="width: 115px; height: 37px; left: 126px; top: 0px; position: absolute">
                  ...
                  <div style="left: 26px; top: 6px; position: absolute; color: white; font-size: 16px; font-family: Poppins; font-weight: 400; word-wrap: break-word">Riwayat</div>
                </div>
              </div>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <form action='hapus_riwayat' method="post">
                                                    @csrf
